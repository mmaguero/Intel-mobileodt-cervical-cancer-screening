...
def rf(traindata, trainlabel, validData, validLabel, testData):
    ...
    rfClf = RandomForestClassifier(n_estimators=1000, oob_score=True, n_jobs=-1, random_state=RDM, verbose=20,
                                   criterion='gini')
...
if __name__ == '__main__':
    ...
    print(d2_valid_features.shape)
    print(d1_valid_target.shape)
